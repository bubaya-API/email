...
if(isset($_POST['dosub'])){
	...
	if ( preg_match( $pattern, $email_address ) ){
		$res = send_mail($email_address,$_POST['title'],$_POST['content']);
	}
}
...
function send_mail($tomail, $subject, $body){
    ...
    $mail->Host = "smtp.163.com";				//邮箱服务器名称
    $mail->Port = 25;							//邮箱服务端口
    $mail->Username = "hwlfcwl@163.com";			//发件人邮箱地址
    $mail->Password = "501501";					//发件人邮箱密码
    $mail->CharSet = "UTF-8";
    $mail->SetFrom('hwlfcwl@163.com', '展亚资本');		//发件人信息 邮箱地址，姓名
